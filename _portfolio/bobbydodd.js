...
function createStadium() {
    ...
    var tip = d3.tip()
        ...
        .offset([0, 0])
        .direction("s")
        .html(function(d) { return "<span>Section: </span>" + d.section_name + "<br />" + "<span>WTP: </span>" + format(d.Wtp) + "<br />" + "<span>Bounds: </span>" + format(d.lower_bound) + " - " + format(d.upper_bound) + "<br />" + "<span>Face Value: </span>" + format(d.Face) + "<br />" + "<span>Net Difference: </span>" + format(d.Net) });
